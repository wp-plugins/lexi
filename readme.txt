...
An RSS reader that can be placed in pages, posts and sidebar, using ajax to show contents after the site has been loaded, and avoiding site block waiting for feeds.
