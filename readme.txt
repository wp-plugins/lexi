...
An RSS reader that can be placed in pages, posts and sidebar. It avoids site blocking during page creation while the page  waits for feeds, because Lexi uses ajax to show contents after the site has been loaded.
